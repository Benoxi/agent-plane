...
function ProjectDetail({ group }: { group: SidebarProjectSnapshot }) {
  ...
  const claudeImportTarget = useMemo(
    () => claudeSessionImportTargetForProject(selectedCheckout),
    [selectedCheckout],
  );
      ...
      <SettingsPageContainer>
        ...
        >
          ...
          <SettingsRow
            ...
            description="Import a previous Claude session into this checkout as a T3 thread."
            control={
              <Button size="xs" variant="outline" onClick={() => setClaudeImportOpen(true)}>
