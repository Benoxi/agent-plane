...
function ToastExpandableSection({
  ...
  return (
    <div className="min-w-0">
      <button
        aria-expanded={open}
        className="inline-flex cursor-pointer items-center gap-1 rounded-md py-0.5 text-left text-sm font-medium text-muted-foreground transition-colors hover:text-foreground"
          ...
          return (
            <Toast.Root
              className={cn(
                ...
                "[--toast-gap:--spacing(3)] [--toast-peek:--spacing(3)] [--toast-scale:1] [--toast-shrink:0]",
            ...
            >
              ...
              <Toast.Content
                className={cn(
                  ...
                  "pointer-events-auto min-h-0 overflow-y-visible pl-3.5 text-base leading-relaxed transition-opacity duration-250 [overflow-x:clip] data-expanded:opacity-100",
                  stackedActionLayout
      ...
      <Toast.Viewport className="outline-none" data-slot="toast-viewport-anchored">
        {toasts
          ...
          .map((toast) => {
            ...
            return (
              <Toast.Positioner
                className="z-100 max-w-[min(--spacing(96),var(--available-width))]"
              ...
              >
                <Toast.Root
                  className={cn(
                    "relative overflow-visible text-balance border bg-popover not-dark:bg-clip-padding text-popover-foreground transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:shadow-[0_1px_--theme(--color-black/4%)] data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0 dark:before:shadow-[0_-1px_--theme(--color-white/6%)]",
                    tooltipStyle
                      ? "rounded-md text-xs shadow-md/5 before:rounded-[calc(var(--radius-md)-1px)]"
                      : "rounded-lg text-base shadow-lg/5 before:rounded-[calc(var(--radius-lg)-1px)]",
                  )}
                ...
                >
                  {tooltipStyle ? (
                    ...
                    <>
                      ...
                      <Toast.Content
                        className={cn(
                          "pointer-events-auto min-h-0 overflow-y-visible pl-3.5 text-base leading-relaxed [overflow-x:clip]",
                          stackedActionLayout
                            ? "flex flex-col gap-2 py-2.5 pr-3.5"
                            : cn(
                                "py-3",
